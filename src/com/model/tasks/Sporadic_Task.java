...
public class Sporadic_Task extends Task {

	public Sporadic_Task(String id,String name, String cpu_name,String address_space_name,int capacity,int deadline, int start_time
